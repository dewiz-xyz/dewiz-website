...
- Arrange the lead heading and paragraph in two columns so the card stays compact and readable.
...
- At 767 pixels and below, the three cards retain their source order in one column and the lead card's internal heading/paragraph layout becomes one column.
